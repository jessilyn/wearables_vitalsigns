...
experiments.nopers = mclapply(1:6, function(x) { bootstrap.experiment(iPOPcorDf, wear, debug = FALSE, bootstrap = TRUE, demographics = TRUE, personalized = FALSE) }, mc.cores = 6)
