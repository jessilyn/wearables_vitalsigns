...
#clean vitals; labs were cleaned in the script that created corDf (see 20170908_thirtyk.R)
# looks like corDf is not cleaned (e.g. I found Pulse = 0 for some people.) Need to clean this data (I've done this before, just need to find script.)
...
#################################
#  Figure 2B  - see Lukasz code #
#################################

###################################
#  Figure 2D-F  - see Ryan's code #
###################################
...
#               "BASOAB","BUN","CA","CHOL","CHOLHDL","CL","CO2",
#               "CR","EOS","EOSAB","ESR", "GLOB","GLU","HCT","HDL",
#               "HGB","HSCRP","IGM","K","LDL","LDLHDL","LYM","LYMAB",
#               "MCH","MCHC","MCV","MONO","MONOAB","NA.","NEUT",
#               "NEUTAB","NHDL","PLT", "RBC","RDW","TBIL","TGL","TP","WBC")
